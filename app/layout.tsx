  ...
  return (
    <html lang="en" className="h-full">
      <body className={`${inter.className} flex flex-col h-full bg-gray-900 text-white`}>
        ...
        <nav className="bg-gray-800 py-1 px-2">
          <ul className="flex justify-around items-center">
            ...
            <li>
              <Link href="/about" className="flex flex-col items-center text-gray-300 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
              <Link href="/contact" className="flex flex-col items-center text-gray-300 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
